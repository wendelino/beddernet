  ...
  return (
    <div className="relative z-10 grid grid-cols-6 gap-3">
      ...
      <BentoCard
        ...
        description="Unser Hosting-Service bietet Ihnen höchste Sicherheit und Datenschutz. Ihre Daten werden ausschließlich in deutschen Rechenzentren gespeichert."
      />
      <BentoCard
        icon={
          <div className="relative flex h-full w-64 items-center mx-auto">
            <svg
            ...
            <span className="text-gradient_indigo-purple mx-auto block w-fit font-semibold text-5xl">
              100%
            </span>
          </div>
        }
        title="Maßgeschneidert"
        description="Eigenes Design für Ihre Webseite. Wir passen jede Webseite individuell an Ihre Bedürfnisse an."
      />
      <BentoCard
        icon={
          <svg
        ...
        title="Performance und SEO"
        description="Genießen Sie blitzschnelle Ladezeiten und eine SEO optimierte Webseite für maximalen Traffic."
      />
        ...
        <div className="grid sm:grid-cols-2">
          <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
            <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
              <ChartArea
                className="mx-auto my-auto text-current"
                strokeWidth={1}
              />
            </div>
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Professionelle Web-Traffic-Analyse für eine optimale Reichweite
              </p>
            </div>
          </div>
          <div className="relative -mb-20 -mr-20   rounded-tl-xl    sm:ml-6 sm:mt-auto">
            <Safari
              url="analyse.beddernet.de"
              mode="simple"
              imageSrc="analytics_mac.png"
      ...
      <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8   lg:col-span-3">
        <div className="grid h-full sm:grid-cols-2 gap-12">
          <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
            <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
              <svg
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Nahtlose Integrationen in Ihre bestehenden Systeme
              </p>
            </div>
          </div>
          <div className="sm:absolute inset-0 flex items-center justify-end w-full sm:max-w-xs sm:pr-4 ml-auto">
            <AnimatedBeamDemo />
          </div>
        </div>
      </div>
...
>(({ className, icon, label }, ref) => {
  return (
    <div className="flex items-center gap-2">
      ...
      {label && <span className="   truncate  text-sm px-1">{label}</span>}
    </div>
  );
});
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-8 justify-center ">
        ...
        <Circle ref={div4Ref} icon={<Mail />} label="E-Mail Marketing" />
      </div>
      <AnimatedBeam
